...
},{"@uppy/utils/lib/findDOMElement":195,"preact":53}],88:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"../package.json":91,"./Plugin":87,"./loggers":89,"./supportsUploadProgress":90,"@uppy/store-default":159,"@uppy/utils/lib/Translator":190,"@uppy/utils/lib/generateFileID":196,"@uppy/utils/lib/getFileNameAndExtension":203,"@uppy/utils/lib/getFileType":204,"@uppy/utils/lib/prettyBytes":216,"cuid":13,"lodash.throttle":46,"mime-match":48,"namespace-emitter":49}],89:[function(require,module,exports){
...
},{"@uppy/utils/lib/getTimeStamp":208}],90:[function(require,module,exports){
...
},{"./AddFiles":92,"./AddFilesPanel":93,"./FileCard":95,"./FileList":102,"./PickerPanelContent":104,"./PickerPanelTopBar":105,"@uppy/utils/lib/isTouchDevice":213,"classnames":9,"preact":53,"preact-css-transition-group":52}],95:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"../../../utils/truncateString":115,"@uppy/utils/lib/prettyBytes":216,"preact":53}],98:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"../package.json":116,"./components/Dashboard":94,"./components/icons":106,"./utils/createSuperFocus":109,"./utils/trapFocus":114,"@uppy/core":88,"@uppy/informer":124,"@uppy/status-bar":157,"@uppy/thumbnail-generator":162,"@uppy/utils/lib/Translator":190,"@uppy/utils/lib/findAllDOMElements":194,"@uppy/utils/lib/getDroppedFiles":198,"@uppy/utils/lib/toArray":220,"cuid":13,"memoize-one":47,"resize-observer-polyfill":57}],108:[function(require,module,exports){
/**
...
},{"./getActiveOverlayEl":110,"@uppy/utils/lib/FOCUSABLE_ELEMENTS":189,"lodash.debounce":45}],110:[function(require,module,exports){
/**
...
},{"./getActiveOverlayEl":110,"@uppy/utils/lib//FOCUSABLE_ELEMENTS":189,"@uppy/utils/lib/toArray":220}],115:[function(require,module,exports){
/**
...
},{"../package.json":120,"@uppy/core":88,"@uppy/utils/lib/findDOMElement":195,"@uppy/utils/lib/toArray":220,"get-form-data":37}],120:[function(require,module,exports){
module.exports={
  "name": "@uppy/form",
...
},{"../package.json":140,"./AuthView":128,"./Browser":130,"./Loader":138,"@uppy/utils/lib/generateFileID":196,"@uppy/utils/lib/getFileType":204,"@uppy/utils/lib/isPreviewSupported":212,"preact":53}],140:[function(require,module,exports){
module.exports={
...
},{"@uppy/core":88,"@uppy/utils/lib/findDOMElement":195,"@uppy/utils/lib/toArray":220}],143:[function(require,module,exports){
function _assertThisInitialized(self) {
  if (self === void 0) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
...
},{"@uppy/core":88,"@uppy/utils/lib/findDOMElement":195}],144:[function(require,module,exports){
function _extends() {
...
},{"@uppy/dashboard":107,"@uppy/utils/lib/hasProperty":209}],146:[function(require,module,exports){
function _extends() {
  _extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
},{"@uppy/dropbox":117,"@uppy/google-drive":122,"@uppy/instagram":126,"@uppy/transloadit":168,"@uppy/url":186,"@uppy/utils/lib/hasProperty":209,"@uppy/webcam":226}],147:[function(require,module,exports){
var Transloadit = require('@uppy/transloadit');
...
},{"./TransloaditResultsPlugin":144,"@uppy/transloadit":168,"@uppy/utils/lib/hasProperty":209}],148:[function(require,module,exports){
function _extends() {
  _extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
},{"@uppy/core":88,"@uppy/utils/lib/hasProperty":209}],149:[function(require,module,exports){
function _extends() {
  _extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
},{"./AttachFileInputs":142,"./TransloaditFormResult":143,"./addDashboardPlugin":145,"./addProviders":146,"./addTransloaditPlugin":147,"@uppy/core":88,"@uppy/form":119,"@uppy/status-bar":157,"@uppy/utils/lib/findDOMElement":195,"@uppy/utils/lib/hasProperty":209}],151:[function(require,module,exports){
...
},{"./addTransloaditPlugin":147,"./createUppy":148,"@uppy/utils/lib/toArray":220}],154:[function(require,module,exports){
module.exports={
  "name": "@uppy/robodog",
...
},{"./StatusBarStates":156,"@uppy/utils/lib/prettyBytes":216,"@uppy/utils/lib/prettyETA":217,"classnames":9,"lodash.throttle":46,"preact":53}],156:[function(require,module,exports){
module.exports = {
  STATE_ERROR: 'error',
  STATE_WAITING: 'waiting',
  STATE_PREPROCESSING: 'preprocessing',
...
},{"../package.json":158,"./StatusBar":155,"./StatusBarStates":156,"@uppy/core":88,"@uppy/utils/lib/Translator":190,"@uppy/utils/lib/getBytesRemaining":197,"@uppy/utils/lib/getSpeed":207}],158:[function(require,module,exports){
module.exports={
...
},{"../package.json":163,"./image-orientations":161,"@uppy/core":88,"@uppy/utils/lib/Translator":190,"@uppy/utils/lib/dataURItoBlob":192,"@uppy/utils/lib/isObjectURL":211,"@uppy/utils/lib/isPreviewSupported":212,"exif-js":35}],163:[function(require,module,exports){
module.exports={
...
},{"./parseUrl":169,"@uppy/utils/lib/hasProperty":209,"component-emitter":11,"socket.io-client":58}],165:[function(require,module,exports){
/**
...
},{"../package.json":170,"./Assembly":164,"./AssemblyOptions":165,"./AssemblyWatcher":166,"./Client":167,"@uppy/core":88,"@uppy/tus":172,"@uppy/utils/lib/Translator":190}],169:[function(require,module,exports){
...
var getFingerprint = require('./getFingerprint'); // Extracted from https://github.com/tus/tus-js-client/blob/master/lib/upload.js#L13
...
},{"../package.json":184,"./getFingerprint":171,"@uppy/companion-client":84,"@uppy/core":88,"@uppy/utils/lib/emitSocketProgress":193,"@uppy/utils/lib/getSocketHost":206,"@uppy/utils/lib/limitPromises":214,"@uppy/utils/lib/settle":219,"tus-js-client":182}],173:[function(require,module,exports){
"use strict";
...
},{"../package.json":188,"./UrlUI.js":185,"./utils/forEachDroppedOrPastedUrl":187,"@uppy/companion-client":84,"@uppy/core":88,"@uppy/utils/lib/Translator":190,"preact":53}],187:[function(require,module,exports){
var toArray = require('@uppy/utils/lib/toArray');
/*
  SITUATION
...
},{"@uppy/utils/lib/toArray":220}],188:[function(require,module,exports){
module.exports={
  "name": "@uppy/url",
...
},{"lodash.throttle":46}],194:[function(require,module,exports){
...
},{"../../../toArray":220,"./getFilesAndDirectoriesFromDirectory":200,"./getRelativePath":201}],203:[function(require,module,exports){
/**
...
},{"./getFileNameAndExtension":203,"./mimeTypes":215}],205:[function(require,module,exports){
...
},{"./RecordButton":224,"./SnapshotButton":225,"preact":53}],223:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"preact":53}],224:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"./CameraIcon":221,"preact":53}],226:[function(require,module,exports){
var _class, _temp;
...
},{"../package.json":228,"./CameraIcon":221,"./CameraScreen":222,"./PermissionsScreen":223,"./supportsMediaRecorder":227,"@uppy/core":88,"@uppy/utils/lib/Translator":190,"@uppy/utils/lib/canvasToBlob":191,"@uppy/utils/lib/getFileTypeExtension":205,"preact":53}],227:[function(require,module,exports){
